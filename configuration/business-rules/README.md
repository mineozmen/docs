...
Business rules are typically used by rule handlers such as [DroolsProcessEventHandler](../../devops/microservices/elements/handlers/specialized-handlers/apply-advanced-rules.md).
