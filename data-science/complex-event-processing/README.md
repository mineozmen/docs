...
Data flows are typically used by data flow handlers such as [JsonSiddhiEventHandler](../../devops/microservices/elements/handlers/specialized-handlers/calculate-real-time-metrics.md).
