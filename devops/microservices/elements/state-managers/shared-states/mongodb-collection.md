...
This state manager supports [CallSP](../../handlers/core-handlers/write-data.md) action of write event handler, where command can be either of deleteOne, deleteMany, updateOne or updateMany and input contents can include following fields:
