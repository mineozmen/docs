...
Use [Flow Actions](../../../api-flows/configuring-saga-steps/event-step/flow-actions/) for action-level saga step fields and parameters.
...
Action details: [Orchestrate Saga](../../../api-flows/configuring-saga-steps/event-step/flow-actions/orchestrate-saga.md)
...
Action details: [Execute Predefined Actions](../../../api-flows/configuring-saga-steps/event-step/flow-actions/execute-predefined-actions.md)
...
Action details: [Loop Each Entry](../../../api-flows/configuring-saga-steps/event-step/flow-actions/loop-each-entry.md)
...
Action details: [Run Multiple Steps](../../../api-flows/configuring-saga-steps/event-step/flow-actions/run-multiple-steps.md)
...
Action details: [Buffer Payloads](../../../api-flows/configuring-saga-steps/event-step/flow-actions/buffer-payloads.md)
...
Action details: [Merge Parallel Steps](../../../api-flows/configuring-saga-steps/event-step/flow-actions/merge-parallel-steps.md)
...
Action details: [Log Event](../../../api-flows/configuring-saga-steps/event-step/flow-actions/log-event.md)
...
Action details: [Send Event](../../../api-flows/configuring-saga-steps/event-step/flow-actions/send-event.md)
...
Action details: [Validate Event](../../../api-flows/configuring-saga-steps/event-step/flow-actions/validate-event.md)
...
Action details: [Transform Event](../../../api-flows/configuring-saga-steps/event-step/flow-actions/transform-event.md)
...
Action details: [Lock & Unlock](../../../api-flows/configuring-saga-steps/event-step/flow-actions/lock-and-unlock.md)
...
Action details: [Perform DB Transaction](../../../api-flows/configuring-saga-steps/event-step/flow-actions/perform-db-transaction.md)
...
Action details: [Trigger Runner Command](../../../api-flows/configuring-saga-steps/event-step/flow-actions/trigger-runner-command.md)
...
Action details: [Do Nothing](../../../api-flows/configuring-saga-steps/event-step/flow-actions/do-nothing.md)
