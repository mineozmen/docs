---
description: >-
  This handler (com.rierino.handler.QueryEventHandler) provides ability to
  generate and execute system specific queries on a query manager on demand,
  from simple select statements to complex requests.
---
...
| ----------- | --------------------------------------------------- | ------------- | ------- |
| query.state | Name of the state manager storing query definitions | customQueries | query   |

{% file src="../../../../../.gitbook/assets/handler-query-0001.json" %}
Example Query Handler Definition (Can be Imported on Element Screen)
{% endfile %}
