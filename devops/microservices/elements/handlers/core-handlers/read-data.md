---
description: >-
  This handler (com.rierino.handler.ReadEventHandler) provides ability to select
  one, multiple or all records from a state manager on demand, facilitating
  common REST API read calls.
---
...
This handler requires no parameters. This handler is [cacheable](../#handler-caching).
