...
Use [Specialized Actions](../../../api-flows/configuring-saga-steps/event-step/specialized-actions/) for action-level saga step fields and parameters.
...
Action details: [Apply Advanced Rules](../../../api-flows/configuring-saga-steps/event-step/specialized-actions/apply-advanced-rules.md)
...
Action details: [Calculate Real-time Metrics](../../../api-flows/configuring-saga-steps/event-step/specialized-actions/calculate-real-time-metrics.md)
...
Action details: [Consume Web of Things](../../../api-flows/configuring-saga-steps/event-step/specialized-actions/consume-web-of-things.md)
...
Action details: [Produce Web of Things](../../../api-flows/configuring-saga-steps/event-step/specialized-actions/produce-web-of-things.md)
...
Action details: [Generate Excel](../../../api-flows/configuring-saga-steps/event-step/specialized-actions/generate-excel.md)
...
Action details: [Generate PDF](../../../api-flows/configuring-saga-steps/event-step/specialized-actions/generate-pdf.md)
...
Action details: [Call SOAP API](../../../api-flows/configuring-saga-steps/event-step/specialized-actions/call-soap-api.md)
...
Action details: [Integrate with Camel](../../../api-flows/configuring-saga-steps/event-step/specialized-actions/integrate-with-camel.md)
