...
Includes settings required for change data capture flows of a specific data table from [CDC systems](../systems-integrations/#cdc). Typically, name of this stream matches the source table name.
