...
Use [ML & AI Actions](../../../api-event-and-process-flows/configuring-saga-steps/event-step/ml-and-ai-actions/) for action-level saga step fields and parameters.
...
Action details: [Use ML Models](../../../api-event-and-process-flows/configuring-saga-steps/event-step/ml-and-ai-actions/use-ml-models.md)
...
Action details: [Use GenAI Models](../../../api-event-and-process-flows/configuring-saga-steps/event-step/ml-and-ai-actions/use-genai-models.md)
...
Action details: [Service MCP Requests](../../../api-event-and-process-flows/configuring-saga-steps/event-step/ml-and-ai-actions/service-mcp-requests.md)
...
Action details: [Service A2A Requests](../../../api-event-and-process-flows/configuring-saga-steps/event-step/ml-and-ai-actions/service-a2a-requests.md)
