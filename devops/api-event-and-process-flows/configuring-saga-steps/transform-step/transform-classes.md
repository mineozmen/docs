...
This class(_com.rierino.handler.transform.GenerateIDTransform_) uses an [ID generator](../../../microservices/building-blocks/data-sources/id-generators.md) to create a unique ID inside the payload.
