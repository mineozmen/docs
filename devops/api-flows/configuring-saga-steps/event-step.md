...
* **Parameter Map:** Handler and action specific list of parameters to use for the event. For a full list of these parameters, please refer to [Handlers](../../microservices/elements/handlers/).
...
1. Defining predefined "Action" records and using [execute-predefined-actions.md](../../microservices/elements/handlers/flow-handlers/execute-predefined-actions.md "mention") handler to call them.
2. Defining structural [actions.md](../../microservices/elements/actions.md "mention") runner elements with the default values and using them as event actions for requests to runners with these elements.
