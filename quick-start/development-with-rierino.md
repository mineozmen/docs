---
description: >-
  Devops, Configuration, Design and Data Science apps allow users develop
...
Start here when your use case needs inference, agents, personalization, or stream processing. See [Data Science Overview](../data-science/data-science-overview.md).
...
* Checking feature availability by versions in [release notes](../troubleshooting/rierino-release-notes.md)
