---
description: Custom menu actions are specific to certain types of screens or listers.
---
...
An item level menu action, which allows automatically generating [source](../../../api-mapping/) and [UI](../) entries for a [data model](../../../data-schema/) schema.
